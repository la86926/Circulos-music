(()=>{
'use strict';
if(window.__circulosPerformanceModeV9)return;
window.__circulosPerformanceModeV9=true;
...
if(!document.querySelector('link[href*="performance-ui.css"]')){
  ...
  link.rel='stylesheet';
  link.href='performance-ui.css?v=10';
...
function clicSinSonido(elemento){if(elemento)elemento.click();}
