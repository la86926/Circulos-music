(()=>{
'use strict';
if(window.__circulosPianoSyncV10)return;
window.__circulosPianoSyncV10=true;
...
function playKey(key){if(!key.dataset.performanceMidi&&key.closest('#pianoKeyboard'))assignCircleMidis();flashKey(key);}
